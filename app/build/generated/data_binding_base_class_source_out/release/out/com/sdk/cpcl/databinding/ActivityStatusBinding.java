...
public final class ActivityStatusBinding implements ViewBinding {
  ...
  private ActivityStatusBinding(@NonNull LinearLayout rootView, @NonNull Button btnRefresh,
  ...
  public static ActivityStatusBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityStatusBinding((LinearLayout) rootView, btnRefresh, txtStatus);
    }
